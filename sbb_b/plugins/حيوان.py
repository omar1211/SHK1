...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 ╼•✬• 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊 ➪︎ @L_H_V  •✬•╾ "
    ...
    if x == 3:
       ...
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𓆩 ╼•✬• 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊 ➪︎ @L_H_V  •✬•╾ 𓆪  "
...
async def who(event):
    ...
    if replied_user.id == 5328713035 or replied_user.id == 5328713035 or replied_user.id == 5328713035:
