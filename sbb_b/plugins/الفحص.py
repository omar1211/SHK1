...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "[• 父 ✓ ѕʜᴀʀᴋ 𝙸𝚂 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 ✓ 父 •](t.me/L_H_V)**"
...
\n**[• 父 ✓ ѕʜᴀʀᴋ 𝙸𝚂 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 ✓ 父 •](t.me/L_H_V)"""
...
ROZ_PIC = "https://telegra.ph/file/98d9ab26a614961c417fd.jpg"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("السورس") and event.query.user_id == sbb_b.uid:
            buttons = [
                [
                    Button.url("𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐇𝐀𝐑𝐊", "t.me/L_H_V"),
                    Button.url("★⃝➼3𝕄𝕆ℝ𝕐🜪 . 🕷 ˼", "https://t.me/T_3_A"),
                ]
            ]
